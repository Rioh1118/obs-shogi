> **アーカイブ（2026-07-27）** — このロードマップは 2026-06 の方針転換（issue #112）により廃止された。
> 現行の方針は issue #112 と `obs-shogi-spec.md` を参照。以下は経緯の記録として保存する。
> 元データ: `origin/docs/research-roadmap` ブランチの `docs/ROADMAP.md`
