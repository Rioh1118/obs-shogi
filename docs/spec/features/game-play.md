...
main にあるか: **始める面と進行を出す面まで。人が指せない**
...
残りは2つ。**対局の設定・時計・終局は入った**（→ [screens/play-view.md](../screens/play-view.md)）。
...
**対局中の盤だけは決まっていない。** どの層が「自分の手番か」の門を持つかを、
[screens/board.md](../screens/board.md) と この doc が互いに送り合ったまま誰も決めていない。
