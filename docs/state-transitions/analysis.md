...
| **S6/P1** | 握っていれば返してから始める※11 | 握っていれば席を返す                                | —                | —           | —                                                   | 開始の応答待ちなら S0/P1 と同じ（席の世代が進む）。▶ は先頭で席を返すので、同期待ちに入る時点で P0 | 捨てる※3          | —                      | → S6 のまま※1 | → S6 のまま※11                                                    | ▶ の先頭の返却が落ちた回 → S6・**席は握ったまま**（※2 / ※15） | —                                                 | 席を返す※12                                           | 席を握っていれば返す※14                               |
