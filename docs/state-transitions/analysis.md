...
| **S2/P1** | —                               | → S0 タイマ破棄                                     | 最新で上書き     | → S4 へ     | —                 | **→ S1 のまま**／P は畳み方で違う※5 | 反映              | → S0                   | → S6                 | —                                                                        | —                                                       | —                                              | 席を返す※12                                           | 席を返して → S0※14                                    |
| **S3/P1** | —                               | → S0                                                | 待ち対象を更新※8 | → S4 へ     | **停止して S6**※9 | **→ S1 のまま**／P は畳み方で違う※5 | —                 | —                      | → S6                 | —                                                                        | → S6・**席は握ったまま**（※9 / P は枝で違う → ※12）     | —                                              | 席を返す※12                                           | 席を返して → S0※14                                    |
| **S4/P1** | —                               | → S0※10                                             | → S5             | —           | —                 | **→ S1 のまま**／P は畳み方で違う※5 | —                 | —                      | → S6                 | → S6 + `stop_analysis`                                                   | → S6・**席は握ったまま**（P は枝で違う → ※12）          | —                                              | 席を返す※12・※13                                      | 席を返して → S0※14・※13                               |
| **S5/P1** | —                               | → S0※10                                             | 最新で上書き     | —           | —                 | **→ S1 のまま**／P は畳み方で違う※5 | —                 | —                      | → S6                 | → S6                                                                     | → S6・**席は握ったまま**（P は枝で違う → ※12）          | —                                              | 席を返す※12・※13                                      | 席を返して → S0※14・※13                               |
| **S6/P0** | 再開できる                      | —                                                   | —                | —           | —                 | —                                   | —                 | —                      | —                    | —                                                                        | —                                                       | —                                              | —                                                     | —                                                     |
...
※13 開始の応答を待っている間に畳まれた回。**席の欄が空なら**——前の停止に成功していれば
