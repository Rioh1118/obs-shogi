...
| **S4/P1** | —                   | → S0※10                                             | → S5             | —           | —                 | ※5                | —                 | —                      | → S6                 | → S6 + `stop_analysis` | → S6・**席は握ったまま**（P は枝で違う → ※12） | —                                              | 席を返す※12・※13                                      |
| **S5/P1** | —                   | → S0※10                                             | 最新で上書き     | —           | —                 | ※5                | —                 | —                      | → S6                 | → S6                   | → S6・**席は握ったまま**（P は枝で違う → ※12） | —                                              | 席を返す※12・※13                                      |
| **S6/P0** | 再開できる          | —                                                   | —                | —           | —                 | —                 | —                 | —                      | —                    | —                      | —                                              | —                                              | —                                                     |
...
停止が届かずに握ったまま開始した回は欄が埋まっているので、畳まれた側も1本撃つ
（そちらは指さない停止なので、後から載った席も一緒に空く）。
...
1. **フロントが S0（停止中）なら Rust も P0。** ※7 と、要らなくなった開始を捨てる停止が
   届かなかった回（※12 の2つ目）がこれを破る。
