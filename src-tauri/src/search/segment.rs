...
use super::{position_key::PositionKey, types::PositionHit};
...
impl Segment {
    ...
    pub fn new_sorted(entries: Vec<(PositionKey, PositionHit)>) -> Self {
        Self { entries }
    }
    ...
    pub fn range_by_key(&self, key: PositionKey) -> &[(PositionKey, PositionHit)] {
