...
const PositionListItem = forwardRef<HTMLDivElement, Props>(
  function PositionListItem({ position, selected, onClick, turnLabel, tesuu }, ref) {
    ...
    return (
      ...
      >
        <div className="sp-list-item__top">
          <span className="sp-list-item__label">
        ...
        <div className="sp-list-item__bottom">
          ...
          {position.tags.length > 2 && (
            <span className="sp-list-item__tagMore">
              +{position.tags.length - 2}
            </span>
          )}
          {turnLabel && (
